...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "Blob|CanvasRenderingContext2D|DOMError|File|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|PushManager|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
...
["", "../web/animation.dart", , X, {
  "^": "",
  Anim: {
    "^": "Object;spritesheet,rows,columns,width>,height>,starttime,maxframes,lastframe,timeperframe,framedelayms?,_framedelaysms,totaltime,playing,pausetime,start,end,repeat,flipped?,scaling",
    play$1: function(_, repeat) {
      this.playing = true;
      this.repeat = repeat;
    ...
    getFrame$0: function() {
      ...
      if (!this.timeperframe) {
        ...
        if (t1) {
          ...
          t1 = C.JSNumber_methods.toInt$0(Math.floor(time / this.framedelayms));
          t2 = this.maxframes;
          if (typeof t2 !== "number")
            return H.iae(t2);
          t2 = C.JSInt_methods.$mod(t1, t2);
          this.lastframe = t2;
          t1 = t2;
        }
      } else {
        ...
        if (t1) {
          ...
          if (typeof t1 !== "number")
            return H.iae(t1);
          C.JSInt_methods.$mod(time, t1);
          for (t1 = this._framedelaysms, frametime = 0, i = 0; C.JSInt_methods.$lt(i, C.JSNull_methods.get$length(t1)); ++i)
            frametime = C.JSNumber_methods.$add(frametime, C.JSNull_methods.$index(t1, i));
          t1 = i - 1;
          this.lastframe = t1;
        }
      }
    ...
    Anim$4: function(spritesheet, width, height, maxframes) {
      var t1, t2;
      t1 = J.getInterceptor$x(spritesheet);
      t2 = t1.get$height(spritesheet);
      if (typeof t2 !== "number")
        return t2.$div();
      this.rows = C.JSDouble_methods.toInt$0(t2 / height);
      t1 = t1.get$width(spritesheet);
      if (typeof t1 !== "number")
        return t1.$div();
      t1 = C.JSDouble_methods.toInt$0(t1 / width);
      this.columns = t1;
      t2 = this.rows;
      if (typeof t2 !== "number")
        return t2.$mul();
      this.maxframes = t2 * t1;
      t1 = this.maxframes;
      if (typeof t1 !== "number")
        return t1.$sub();
      this.end = t1 - 1;
    },
    static: {Anim$: function(spritesheet, width, height, maxframes) {
        var t1 = new X.Anim(spritesheet, null, null, width, height, Date.now(), null, 0, false, 100, null, null, true, 0, 0, null, true, false, 4);
        t1.Anim$4(spritesheet, width, height, maxframes);
        return t1;
      }}
  }
}],
["", "../web/assets.dart", , M, {
  "^": "",
  Assets_buildAnimation: function(path, width, height, maxframes) {
    var ie, t1;
    ie = $.get$Assets_images().$index(0, path);
    if (ie == null) {
      ie = W.ImageElement_ImageElement(null, path, null);
      $.get$Assets_images().$indexSet(0, path, ie);
    }
    $.get$Assets_images().$indexSet(0, path, ie);
    t1 = J.get$onLoad$x(ie);
    return t1.get$first(t1).then$1(new M.Assets_buildAnimation_closure(path, width, height, maxframes, ie));
  },
  Assets_buildAnimation_closure: {
    "^": "Closure:2;_captured_path_0,_captured_width_1,_captured_height_2,_captured_maxframes_3,_captured_spritesheet_4",
    call$1: function(e) {
      var animation = X.Anim$(this._captured_spritesheet_4, this._captured_width_1, this._captured_height_2, null);
      $.get$Assets_animations().$indexSet(0, this._captured_path_0, animation);
      return animation;
    }
  }
}],
["", "../web/camera.dart", , R, {
  "^": "",
  Camera: {
    "^": "Object;canvas,position*,rotation,zoom,trackwidth,trackheight,range,following",
    update$1: function(delta) {
      var t1, t2, t3, t4, t5, t6, t7, t8;
      t1 = this.following;
      if (t1 != null && this.canvas != null) {
        ...
        if (typeof t5 !== "number")
          return t5.$div();
        t6 = this.position;
        t6 = P.max(t5 / 2 / t4, t6.get$x(t6));
        t5 = this.range.storage;
        t7 = t5[0];
        t8 = t3.get$width(t2);
        if (typeof t8 !== "number")
          return t8.$div();
        t1.set$x(0, P.min(t6, t7 - t8 / 2 / t4));
        t8 = this.position;
        t7 = t3.get$height(t2);
        if (typeof t7 !== "number")
          return t7.$div();
        t6 = this.position;
        t6 = P.max(t7 / 2 / t4, t6.get$y(t6));
        t5 = t5[1];
        t2 = t3.get$height(t2);
        if (typeof t2 !== "number")
          return t2.$div();
        t8.set$y(0, P.min(t6, t5 - t2 / 2 / t4));
      }
    },
    Camera$withCanvas$2: function(canvas, range) {
      var t1, t2;
      t1 = J.getInterceptor$x(canvas);
      t2 = t1.get$width(canvas);
      if (typeof t2 !== "number")
        return t2.$div();
      this.trackwidth = t2 / 3;
      t1 = t1.get$height(canvas);
      if (typeof t1 !== "number")
        return t1.$div();
      this.trackheight = t1 / 3;
    },
    static: {Camera$withCanvas: function(canvas, range) {
        var t1 = new Float32Array(H._checkLength(2));
        new Float32Array(H._checkLength(2));
        t1 = new R.Camera(canvas, new T.Vector2(t1), 0, 1, null, null, range, null);
        t1.Camera$withCanvas$2(canvas, range);
        return t1;
      }}
  }
}],
["", "../web/collision.dart", , L, {
  "^": "",
  Collision: {
    "^": "Object;collider,collidee,scenecollidee<,distanceAlongNormal"
  }
}],
["", "../web/collisiondetector.dart", , A, {
  "^": "",
  CollisionDetector: {
    "^": "Object;_collisiondetector$_level",
    detect$0: function() {
      C.JSArray_methods.forEach$1(this._collisiondetector$_level.get$mobs(), new A.CollisionDetector_detect_closure(this));
    },
    collideCircleAndBox$4: function(circlepos, circle, boxpos, box) {
      var t1, t2, t3, t4, t5, t6, horizontalintersection, verticalintersection, t7, t8, t9;
      t1 = circlepos.storage;
      t2 = t1[0];
      t3 = circle.get$hradius();
      t4 = J.getInterceptor$x(boxpos);
      t5 = t4.get$x(boxpos);
      if (typeof t5 !== "number")
        return H.iae(t5);
      if (t2 + t3 > t5) {
        ...
        t3 = circle.hradius;
        t5 = t4.get$x(boxpos);
        t6 = J.get$width$x(box);
        if (typeof t5 !== "number")
          return t5.$add();
        if (typeof t6 !== "number")
          return H.iae(t6);
        horizontalintersection = t2 - t3 < t5 + t6;
      } else
      ...
      if (t2 + t3 > t5) {
        t2 = t1[1];
        t5 = t4.get$y(boxpos);
        t6 = J.get$height$x(box);
        if (typeof t5 !== "number")
          return t5.$add();
        if (typeof t6 !== "number")
          return H.iae(t6);
        verticalintersection = t2 - t3 < t5 + t6;
      } else
      ...
      if (horizontalintersection && verticalintersection) {
        ...
        if (typeof t6 !== "number")
          return H.iae(t6);
        t7 = t4.get$x(boxpos);
        t8 = J.getInterceptor$x(box);
        t9 = t8.get$width(box);
        if (typeof t7 !== "number")
          return t7.$add();
        if (typeof t9 !== "number")
          return H.iae(t9);
        t5 = P.min(t2 + t5 - t6, t7 + t9 - (t1[0] - t5));
        t9 = t1[1];
        t7 = t4.get$y(boxpos);
        if (typeof t7 !== "number")
          return H.iae(t7);
        t6 = t4.get$y(boxpos);
        t8 = t8.get$height(box);
        if (typeof t6 !== "number")
          return t6.$add();
        if (typeof t8 !== "number")
          return H.iae(t8);
        if (t5 > P.min(t9 + t3 - t7, t6 + t8 - (t1[1] - t3)))
          verticalintersection = false;
        else
          horizontalintersection = false;
      }
      if (horizontalintersection) {
        t2 = t1[1];
        t5 = t4.get$y(boxpos);
        t6 = J.getInterceptor$x(box);
        t7 = t6.get$height(box);
        if (typeof t5 !== "number")
          return t5.$add();
        if (typeof t7 !== "number")
          return H.iae(t7);
    ...
    collideCircleAndCircle$4: function(circle1pos, circle1, circle2pos, circle2) {
      var dist, t1;
      dist = circle1pos.$sub(0, circle2pos);
      if (dist.get$length(dist) < circle1.get$hradius() + circle2.get$hradius()) {
        t1 = new T.Vector3(new Float32Array(3));
        t1.setFrom$1(dist);
        return t1.normalize$0().$mul(0, circle1.hradius + circle2.hradius - dist.get$length(dist));
      }
      return;
    }
  },
  CollisionDetector_detect_closure: {
    "^": "Closure:5;_collisiondetector$_captured_this_0",
    call$1: function(mob) {
      var t1;
      if (mob.get$collisionShape() == null)
        return;
      if (mob.collisionShape instanceof X.Circle) {
        t1 = this._collisiondetector$_captured_this_0;
        C.JSArray_methods.forEach$1(t1._collisiondetector$_level.get$scenery(), new A.CollisionDetector_detect__closure(t1, mob));
        C.JSArray_methods.forEach$1(t1._collisiondetector$_level.get$mobs(), new A.CollisionDetector_detect__closure0(t1, mob));
        C.JSArray_methods.forEach$1(t1._collisiondetector$_level.get$warps(), new A.CollisionDetector_detect__closure1(t1, mob));
      }
    }
  },
  CollisionDetector_detect__closure: {
    "^": "Closure:6;_captured_this_1,_captured_mob_2",
    call$1: function(element) {
      var t1, t2, i, shapepos, t3, t4, distanceAlongNormal, collision;
      for (t1 = this._captured_this_1, t2 = this._captured_mob_2, i = 0; i < 20; ++i)
        if (element.get$used()[i] === true && element.collisionShapes[i] != null) {
          shapepos = element.positions[i];
          shapepos = shapepos != null ? shapepos : $.get$Scenery_DEFAULT_POSITION();
          shapepos = J.$add$ns(shapepos, element.position);
          t3 = element.collisionShapes[i];
          t4 = J.getInterceptor(t3);
          if (!!t4.$isBox)
            distanceAlongNormal = t1.collideCircleAndBox$4(t2.position, t2.collisionShape, shapepos, t3);
          else
            distanceAlongNormal = !!t4.$isCircle ? t1.collideCircleAndCircle$4(t2.position, t2.collisionShape, shapepos, t3) : null;
          if (distanceAlongNormal != null) {
            collision = new L.Collision(null, null, null, null);
            collision.collider = t2;
            collision.scenecollidee = element;
            collision.distanceAlongNormal = distanceAlongNormal;
            F.EventBus_broadcastEvent(new F.GameEvent("collision", collision));
          }
        }
    }
  },
  CollisionDetector_detect__closure0: {
    "^": "Closure:5;_captured_this_3,_captured_mob_4",
    call$1: function(othermob) {
      var t1, t2, distanceAlongNormal, collision;
      if (othermob.get$collisionShape() == null || this._captured_mob_4 === othermob)
        return;
      t1 = othermob.collisionShape;
      if (t1 instanceof X.Box) {
        t2 = this._captured_mob_4;
        distanceAlongNormal = this._captured_this_3.collideCircleAndBox$4(t2.position, t2.collisionShape, othermob.position, t1);
        if (distanceAlongNormal != null) {
          collision = new L.Collision(null, null, null, null);
          collision.collider = t2;
  ...
  CollisionDetector_detect__closure1: {
    "^": "Closure:7;_captured_this_5,_captured_mob_6",
    call$1: function(warp) {
      var t1 = this._captured_mob_6;
      if (this._captured_this_5.collideCircleAndBox$4(t1.position, t1.collisionShape, J.get$position$x(warp), warp) != null)
        F.EventBus_broadcastEvent(new F.GameEvent("warp", warp.get$construct()));
    }
  }
}],
["", "../web/collisionshapes.dart", , X, {
  "^": "",
  CollisionShape: {
    "^": "Object;"
  },
  ...
  Circle: {
    "^": "CollisionShape;hradius<,vradius"
  },
  Warpzone: {
    "^": "Box;position*,construct<,width,height"
  }
}],
...
["", "../web/eric.dart", , M, {
  "^": "",
  Eric: {
    "^": "Mob_Subscriber;animations,lastcontact,lastcontactlocation,goingleft,leftpressed,rightpressed,jumppressed,inputchanged,powerlevel<,walkaccel,maxwalk,driftaccel,idlestart,idlespeed,state,contactscenery,contacthorizontal,Subscriber_subscriber_active,Subscriber_filters,active,hidden,flying,animation,image,drawable,collisionShape,position,velocity,anchor,rotation",
    onEvent$1: function($event) {
      var t1, t2, t3, t4;
      t1 = $event.type;
      if (t1 === "collision") {
        t2 = $event.data;
        if (t2.get$scenecollidee() != null) {
          this.lastcontact = Date.now();
          t3 = this.contactscenery;
          t4 = t2.scenecollidee;
          if (t3 == null ? t4 == null : t3 === t4)
            return;
          this.contactscenery = t2.scenecollidee;
          t3 = t2.distanceAlongNormal;
          t4 = new T.Vector3(new Float32Array(H._checkLength(3)));
          t4.setValues$3(0, 1, 0);
          t4 = Math.abs(t3.dot$1(t4));
          t2 = t2.distanceAlongNormal;
          t3 = new T.Vector3(new Float32Array(H._checkLength(3)));
          t3.setValues$3(1, 0, 0);
          if (t4 > Math.abs(t2.dot$1(t3))) {
            this.contacthorizontal = true;
            t2 = true;
          } else {
            this.contacthorizontal = false;
            t2 = false;
          }
          if (this.contactscenery.kills) {
            t3 = this.animations;
            if (t2)
              this.kill$1(t3.$index(0, "death_fall"));
            else
              this.kill$1(t3.$index(0, "death_sideways"));
          } else {
            if (t2) {
              t2 = this.lastcontactlocation;
              t2 = t2 != null && this.position.storage[1] - t2.storage[1] > 240;
            } else
              t2 = false;
            if (t2)
              this.kill$1(this.animations.$index(0, "death_fall"));
          }
          this.lastcontactlocation = this.position;
        } else if (t2.collidee != null && t2.collidee instanceof G.Gloopoid) {
          P.print("found gloop");
          t2.collidee.explode$0();
          t2.collidee.get$powerlevel();
        }
      }
      if (t1 === "keydown") {
        t2 = $event.data;
        if (J.getInterceptor$x(t2).get$keyCode(t2) === 37 || C.KeyboardEvent_methods.get$keyCode(t2) === 65)
          this.leftpressed = true;
        if (C.KeyboardEvent_methods.get$keyCode(t2) === 39 || C.KeyboardEvent_methods.get$keyCode(t2) === 68)
          this.rightpressed = true;
        this.inputchanged = true;
      }
      if (t1 === "keyup") {
        t1 = $event.data;
        if (J.getInterceptor$x(t1).get$keyCode(t1) === 37 || C.KeyboardEvent_methods.get$keyCode(t1) === 65)
          this.leftpressed = false;
        if (C.KeyboardEvent_methods.get$keyCode(t1) === 39 || C.KeyboardEvent_methods.get$keyCode(t1) === 68)
          this.rightpressed = false;
        this.inputchanged = true;
      }
    },
    kill$1: function(anim) {
      this.state = C.EricState_7;
      this.animation = anim;
      anim.set$flipped(this.goingleft);
      J.play$1$x(this.animation, false);
      F.EventBus_broadcastEvent(new F.GameEvent("dead", this));
      this.active = false;
    },
    resurrect$0: function() {
      this.state = C.EricState_0;
      this.active = true;
    },
    update$1: function(delta) {
      var t1, t2, t3, x_rel, t4, t5;
      t1 = Date.now();
      if (t1 - this.lastcontact > 100)
        this.contactscenery = null;
      t2 = this.state;
      if (t2 !== C.EricState_7 && this.contactscenery == null && t2 !== C.EricState_3) {
        this.state = C.EricState_2;
        t2 = C.EricState_2;
      }
      switch (t2) {
        case C.EricState_0:
          t2 = this.animations;
          if (!J.$eq(this.animation, t2.$index(0, "idle"))) {
            this.idlestart = t1;
            t3 = this.velocity;
            this.idlespeed = t3.get$length(t3);
            t2 = t2.$index(0, "idle");
            this.animation = t2;
            if (t2 != null)
              t2.set$flipped(this.goingleft);
          }
          t2 = this.contactscenery;
          if (t2 != null) {
            x_rel = t2 instanceof D.MovingPlatform ? H.interceptedTypeCast(t2, "$isMovingPlatform").velocity.storage[0] : 0;
            t2 = t2.slowdowntime;
            t3 = this.idlestart;
            t4 = t1 - t3;
            if (t2 > t4) {
              t4 = this.velocity.storage;
              t4[0] = t4[0] - x_rel;
              t5 = t4[0] > 0 ? 1 : -1;
              t4[0] = t5 * this.idlespeed * (t2 - t1 + t3) / t2;
              t4[0] = t4[0] + x_rel;
            } else if (t4 > t2)
              this.velocity.storage[0] = x_rel;
          }
          if (this.inputchanged) {
            if (this.leftpressed || this.rightpressed)
              this.state = C.EricState_1;
        ...
        case C.EricState_1:
          t1 = this.animations;
          if (!J.$eq(this.animation, t1.$index(0, "walk"))) {
            t1 = t1.$index(0, "walk");
            this.animation = t1;
            if (t1 != null)
          ...
          t2 = t1[0];
          t3 = this.goingleft ? -1 : 1;
          if (typeof delta !== "number")
            return H.iae(delta);
          t1[0] = t2 + t3 * this.walkaccel * delta / 1000;
          t2 = this.maxwalk;
          if (Math.abs(t1[0]) > t2) {
            t1 = this.velocity;
            t3 = this.goingleft ? -1 : 1;
        ...
        case C.EricState_2:
          t1 = this.animations;
          if (!J.$eq(this.animation, t1.$index(0, "falling"))) {
            t1 = t1.$index(0, "falling");
            this.animation = t1;
            if (t1 != null)
              t1.set$flipped(this.goingleft);
          }
          if (this.leftpressed !== this.rightpressed) {
            this.decideDirection$0();
            t1 = this.velocity.storage;
            ...
            if (typeof delta !== "number")
              return H.iae(delta);
            t1[0] = t2 + t3 * this.driftaccel * delta / 1000;
            t2 = this.maxwalk;
            if (Math.abs(t1[0]) > t2) {
              t1 = this.velocity;
              t3 = this.goingleft ? -1 : 1;
          ...
          if (this.contactscenery != null)
            if (this.contacthorizontal === true)
              if (!this.leftpressed && !this.rightpressed)
                this.state = C.EricState_0;
              else {
                this.state = C.EricState_1;
        ...
        case C.EricState_4:
          t1 = this.animations;
          if (!J.$eq(this.animation, t1.$index(0, "wallgrab")))
            this.animation = t1.$index(0, "wallgrab");
          break;
        case C.EricState_7:
          break;
      }
    },
    decideDirection$0: function() {
      var t1 = this.leftpressed;
      if (t1 && !this.rightpressed) {
        this.goingleft = true;
        this.animation.set$flipped(true);
      } else if (!t1 && this.rightpressed) {
        this.goingleft = false;
        this.animation.set$flipped(false);
      }
    },
    Eric$0: function() {
      var t1, t2, t3;
      $.get$EventBus_subscribers().push(this);
      this.get$filters().push("keydown");
      this.get$filters().push("keyup");
      this.get$filters().push("collision");
      M.Assets_buildAnimation("/assets/huemanatee/animations/eric/manatee_death_fall.png", 24, 24, null).then$1(new M.Eric_closure(this));
      M.Assets_buildAnimation("/assets/huemanatee/animations/eric/manatee_death_sideways.png", 24, 24, null).then$1(new M.Eric_closure0(this));
      M.Assets_buildAnimation("/assets/huemanatee/animations/eric/manatee_idle.png", 24, 24, null).then$1(new M.Eric_closure1(this));
      M.Assets_buildAnimation("/assets/huemanatee/animations/eric/manatee_walk.png", 24, 24, null).then$1(new M.Eric_closure2(this));
      M.Assets_buildAnimation("/assets/huemanatee/animations/eric/manatee_wallgrab.png", 24, 24, null).then$1(new M.Eric_closure3(this));
      M.Assets_buildAnimation("/assets/huemanatee/animations/eric/manatee_falling.png", 24, 24, null).then$1(new M.Eric_closure4(this));
      this.collisionShape = new X.Circle(40, 16);
      ...
      t3[0] = t2 * 4;
      t3[1] = t1 * 4;
      this.anchor = new T.Vector2(t3);
    },
    $isSubscriber: 1,
    static: {Eric$: function() {
        var t1 = new M.Eric(P.LinkedHashMap_LinkedHashMap(null, null, null, null, null), Date.now(), null, false, false, false, false, false, 0, 400, 150, 100, 0, 0, C.EricState_0, null, null, true, [], true, false, false, null, null, null, null, new T.Vector3(new Float32Array(H._checkLength(3))), new T.Vector3(new Float32Array(H._checkLength(3))), new T.Vector2(new Float32Array(H._checkLength(2))), 0);
        t1.Eric$0();
        return t1;
      }}
  },
  Mob_Subscriber: {
    "^": "Mob+Subscriber;subscriber_active:Subscriber_subscriber_active<,filters:Subscriber_filters<"
  },
  Eric_closure: {
    "^": "Closure:2;_eric$_captured_this_0",
    call$1: function(anim) {
      this._eric$_captured_this_0.animations.$indexSet(0, "death_fall", anim);
      return anim;
    }
  },
  Eric_closure0: {
    "^": "Closure:2;_eric$_captured_this_1",
    call$1: function(anim) {
      this._eric$_captured_this_1.animations.$indexSet(0, "death_sideways", anim);
      return anim;
    }
  },
  Eric_closure1: {
    "^": "Closure:2;_eric$_captured_this_2",
    call$1: function(anim) {
      var t1;
      anim.set$framedelayms(500);
      t1 = this._eric$_captured_this_2;
      t1.animations.$indexSet(0, "idle", anim);
      t1.animation = anim;
    }
  },
  Eric_closure2: {
    "^": "Closure:2;_eric$_captured_this_3",
    call$1: function(anim) {
      anim.set$framedelayms(250);
      this._eric$_captured_this_3.animations.$indexSet(0, "walk", anim);
    }
  },
  Eric_closure3: {
    "^": "Closure:2;_captured_this_4",
    call$1: function(anim) {
      this._captured_this_4.animations.$indexSet(0, "wallgrab", anim);
      return anim;
    }
  },
  Eric_closure4: {
    "^": "Closure:2;_eric$_captured_this_5",
    call$1: function(anim) {
      this._eric$_captured_this_5.animations.$indexSet(0, "falling", anim);
      return anim;
    }
  },
  EricState: {
...
["", "../web/events.dart", , F, {
  "^": "",
  EventBus_broadcastEvent: function($event) {
    var t1 = $.get$EventBus_subscribers();
    (t1 && C.JSArray_methods).forEach$1(t1, new F.EventBus_broadcastEvent_closure($event));
  },
  GameEvent: {
    "^": "Object;type,data"
  },
  Subscriber: {
    "^": "Object;subscriber_active:Subscriber_subscriber_active<,filters:Subscriber_filters<"
  },
  EventBus_broadcastEvent_closure: {
    "^": "Closure:17;_captured_event_0",
    call$1: function(subscriber) {
      var t1, t2, t3, filter, t4;
      if (!subscriber.get$subscriber_active())
        return;
      for (t1 = subscriber.Subscriber_filters, t1 = new J.ArrayIterator(t1, t1.length, 0, null), t2 = this._captured_event_0, t3 = t2.type; t1.moveNext$0();) {
        filter = t1.__interceptors$_current;
        t4 = J.getInterceptor(filter);
        if (t4.$eq(filter, t3) || t4.$eq(filter, "all")) {
          subscriber.onEvent$1(t2);
          break;
        }
      }
    }
...
["", "../web/mobs/gloopoids.dart", , G, {
  "^": "",
  Gloopoid: {
    "^": "Mob;powerlevel<,exploded,idle,explosion,active,hidden,flying,animation,image,drawable,collisionShape,position,velocity,anchor,rotation",
    explode$0: function() {
      if (!this.exploded) {
        var t1 = this.explosion;
        this.animation = t1;
        J.play$1$x(t1, false);
        this.exploded = true;
      }
    ...
    Gloopoid$0: function() {
      ...
      this.collisionShape = new X.Box(12, 12);
      this.active = false;
    }
  },
  RedGloopoid: {
    "^": "Gloopoid;powerlevel,exploded,idle,explosion,active,hidden,flying,animation,image,drawable,collisionShape,position,velocity,anchor,rotation",
    RedGloopoid$0: function() {
      M.Assets_buildAnimation("/assets/huemanatee/animations/gloopoids/blob_red_idle.png", 24, 24, null).then$1(new G.RedGloopoid_closure(this));
      M.Assets_buildAnimation("/assets/huemanatee/animations/gloopoids/blob_red_explode.png", 24, 24, null).then$1(new G.RedGloopoid_closure0(this));
      this.powerlevel = 1;
    },
    static: {RedGloopoid$: function() {
        var t1 = new G.RedGloopoid(null, false, null, null, true, false, false, null, null, null, null, new T.Vector3(new Float32Array(H._checkLength(3))), new T.Vector3(new Float32Array(H._checkLength(3))), new T.Vector2(new Float32Array(H._checkLength(2))), 0);
        t1.Gloopoid$0();
        t1.RedGloopoid$0();
        return t1;
      }}
  ...
  RedGloopoid_closure: {
    "^": "Closure:18;_gloopoids$_captured_this_0",
    call$1: function(anim) {
      var t1 = this._gloopoids$_captured_this_0;
      t1.idle = anim;
      t1.animation = anim;
      P.print("gloop ready");
    }
  },
  RedGloopoid_closure0: {
    "^": "Closure:18;_gloopoids$_captured_this_1",
    call$1: function(anim) {
      this._gloopoids$_captured_this_1.explosion = anim;
      return anim;
    }
  }
}],
["", "../web/level.dart", , Y, {
  "^": "",
  Level: {
    "^": "Object;camera<,spawnPoint<,cameraMob,background<,audio,scenery<,mobs<,logic<,warps<"
  }
}],
["", "../web/levelrenderer.dart", , A, {
  "^": "",
  LevelRenderer: {
    "^": "Object;canvas,context,_level",
    draw$1: function(delta) {
      ...
      t2 = this.canvas;
      t3 = t2.parentElement;
      t3 = P.Rectangle$(C.JSNumber_methods.round$0(t3.clientLeft), C.JSNumber_methods.round$0(t3.clientTop), C.JSNumber_methods.round$0(t3.clientWidth), C.JSNumber_methods.round$0(t3.clientHeight), null);
      t2 = t2.parentElement;
      t1.clearRect(0, 0, t3.width, P.Rectangle$(C.JSNumber_methods.round$0(t2.clientLeft), C.JSNumber_methods.round$0(t2.clientTop), C.JSNumber_methods.round$0(t2.clientWidth), C.JSNumber_methods.round$0(t2.clientHeight), null).height);
      t1.save();
      t2 = this._level.get$camera().position;
      t2 = t2.get$x(t2);
      t3 = this._level.get$camera().position;
      t1.translate(-t2 / 1.8, -t3.get$y(t3) / 1.8);
      t1.rotate(-this._level.get$camera().rotation);
      t1.scale(this._level.get$camera().zoom, this._level.get$camera().zoom);
      this.drawScenery$1(this._level.get$background());
      t1.restore();
      t1.save();
      t3 = this._level.get$camera().position;
      t3 = t3.get$x(t3);
      t2 = this._level.get$camera().position;
      t1.translate(-t3, -t2.get$y(t2));
      t1.rotate(-this._level.get$camera().rotation);
      t1.scale(this._level.get$camera().zoom, this._level.get$camera().zoom);
      C.JSArray_methods.forEach$1(this._level.get$scenery(), this.get$drawScenery());
      this.drawMobs$0();
      t1.restore();
    },
    drawMobs$0: function() {
      C.JSArray_methods.forEach$1(this._level.get$mobs(), new A.LevelRenderer_drawMobs_closure(this));
    },
    drawScenery$1: [function(scenery) {
      var t1, t2, t3, t4, t5, itemposition, itemrotation, itemanchor, itemzoom, i, t6, t7, t8, t9;
      t1 = this.context;
      t1.save();
      t1.translate(J.get$x$x(J.get$position$x(scenery)) + scenery.get$anchorPoint().storage[0], scenery.position.storage[1] + scenery.anchorPoint.storage[1]);
      t1.rotate(scenery.rotation);
      for (t2 = scenery.images, t3 = scenery.zooms, t4 = scenery.positions, t5 = scenery.used, itemposition = null, itemrotation = null, itemanchor = null, itemzoom = null, i = 0; i < 20; ++i) {
        if (t5[i] !== true)
          continue;
        itemposition = t4[i];
        itemposition = itemposition != null ? itemposition : $.get$Scenery_DEFAULT_POSITION();
        itemzoom = t3[i];
        itemzoom = itemzoom != null ? itemzoom : 1;
        itemanchor = $.get$Scenery_DEFAULT_ANCHOR();
        t1.save();
        t6 = J.getInterceptor$x(itemposition);
        t7 = t6.get$x(itemposition);
        t8 = itemanchor.storage;
        t9 = t8[0];
        if (typeof t7 !== "number")
          return t7.$add();
        t6 = t6.get$y(itemposition);
        t8 = t8[1];
        if (typeof t6 !== "number")
          return t6.$add();
        t1.translate(t7 + t9, t6 + t8);
        t1.rotate(0);
        t1.scale(itemzoom, itemzoom);
        t6 = t2[i];
        if (t6 != null)
          t1.drawImage(t6, 0, 0);
        t1.restore();
      ...
      t1.restore();
    }, "call$1", "get$drawScenery", 2, 0, 19],
    drawAnimation$1: function(animation) {
      var frame, t1, t2, t3, t4, t5, t6, t7, t8;
      frame = animation.getFrame$0();
      if (animation.flipped) {
        t1 = this.context;
        t1.save();
        t1.scale(-1, 1);
        t1.translate(-animation.width * animation.scaling, 0);
      }
      t1 = this.context;
      t2 = animation.spritesheet;
      t3 = animation.rows;
      if (typeof t3 !== "number")
        return H.iae(t3);
      t3 = C.JSNumber_methods.toInt$0(Math.floor(frame / t3));
      t4 = animation.width;
      t5 = animation.rows;
      if (typeof t5 !== "number")
        return H.iae(t5);
      t5 = C.JSNumber_methods.toInt$0(Math.floor(C.JSInt_methods.$mod(frame, t5)));
      t6 = animation.height;
      t7 = animation.width;
      t8 = animation.scaling;
      t1.drawImage(t2, t3 * t4, t5 * t6, t7, t6, 0, 0, t7 * t8, t6 * t8);
      if (animation.flipped)
        t1.restore();
    }
  },
  LevelRenderer_drawMobs_closure: {
    "^": "Closure:5;_levelrenderer$_captured_this_0",
    call$1: function(mob) {
      var t1, t2, t3;
      t1 = J.getInterceptor$x(mob);
      if (t1.get$hidden(mob) === true)
        return;
      t2 = this._levelrenderer$_captured_this_0;
      t3 = t2.context;
      t3.save();
      t3.translate(J.get$x$x(t1.get$position(mob)) - mob.get$anchor().storage[0], mob.position.storage[1] - mob.anchor.storage[1]);
      t3.rotate(mob.rotation);
      t1 = mob.animation;
      if (t1 != null)
        t2.drawAnimation$1(t1);
      t3.restore();
    }
  }
}],
...
["", "../web/main.dart", , F, {
  ...
  HuemanateeClient: {
    "^": "Subscriber;level,canvas,collisiondetector,levelrenderer,physicsapplicator,eric,starttime,lasttime,newlevel,newlevelcallback,Subscriber_subscriber_active,Subscriber_filters",
    gameLoop$1: [function(delta) {
      var t1, time;
      t1 = {};
      t1._captured_delta_0 = delta;
      if (this.newlevel) {
        this.loadLevel$1(this.newlevelcallback$2(this.canvas, this.eric));
        this.newlevel = false;
      }
      time = Date.now() - this.starttime;
      t1._captured_delta_0 = time - this.lasttime;
      this.lasttime = time;
      C.JSArray_methods.forEach$1(this.level.get$logic(), new F.HuemanateeClient_gameLoop_closure(t1));
      this.level.get$camera().update$1(t1._captured_delta_0);
      this.physicsapplicator.update$1(t1._captured_delta_0);
      this.collisiondetector.detect$0();
      this.levelrenderer.draw$1(t1._captured_delta_0);
      C.Window_methods.get$animationFrame(window).then$1(this.get$gameLoop());
    }, "call$1", "get$gameLoop", 2, 0, 20],
    onEvent$1: function(e) {
      var t1 = e.type;
      if (t1 === "warp") {
        P.print("warping");
        this.newlevel = true;
        this.newlevelcallback = e.data;
      } else if (t1 === "dead") {
        P.print("dead");
        P.Timer_Timer(P.Duration$(0, 0, 0, 3000, 0, 0), new F.HuemanateeClient_onEvent_closure(this, e));
      }
    },
    loadLevel$1: function(l) {
      this.level = l;
      this.levelrenderer._level = l;
      this.physicsapplicator._physicsapplicator$_level = l;
      this.collisiondetector._collisiondetector$_level = l;
    },
    HuemanateeClient$0: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8, level1, t9, t10, t11, t12, t13, t14, floors;
      t1 = this.canvas;
      J.getInterceptor$x(t1).get$context2D(t1).imageSmoothingEnabled = false;
      ...
      if (typeof t4 !== "number")
        return t4.$div();
      t2.translate(t3 / 2, t4 / 2);
      this.levelrenderer = new A.LevelRenderer(t1, C.CanvasElement_methods.get$context2D(t1), null);
      t4 = this.eric;
      if ($.RedZone_index == null) {
        t2 = W.AudioElement_AudioElement("/assets/huemanatee/audio/TheDepthOfColour.mp3");
        $.RedZone_audio = t2;
        t2.loop = true;
        t2.play();
        $.RedZone_bg_img = W.ImageElement_ImageElement(null, "/assets/huemanatee/maps/red/red_bg.png", null);
        t2 = new Float32Array(H._checkLength(3));
        t3 = new Float32Array(H._checkLength(3));
        t5 = P.List_List$filled(20, false, null);
        t6 = P.List_List$filled(20, false, null);
        t7 = Array(20);
        t7.fixed$length = Array;
        t8 = Array(20);
        t8.fixed$length = Array;
        t8 = new Z.Scenery(new T.Vector3(t2), 0, new T.Vector3(t3), 200, false, t5, t6, Array(20), Array(20), Array(20), t7, Array(20), Array(20), Array(20), t8);
        $.RedZone_background = t8;
        t7 = new T.Vector3(new Float32Array(H._checkLength(3)));
        t7.setValues$3(0, 0, 1.3);
        t8.position = t7;
        t7 = $.RedZone_background.getFreeIndex$0();
        $.RedZone_index = t7;
        t8 = $.RedZone_background;
        t6 = t8.images;
        t5 = $.RedZone_bg_img;
        if (t7 < 0 || t7 >= 20)
      ...
      t5 = [];
      t6 = [];
      level1 = new Y.Level(new R.Camera(null, new T.Vector2(new Float32Array(H._checkLength(2))), 0, 1, null, null, new T.Vector2(new Float32Array(H._checkLength(2))), null), new T.Vector2(new Float32Array(H._checkLength(2))), null, null, null, t2, t3, t5, t6);
      t7 = new Float32Array(H._checkLength(3));
      t8 = new Float32Array(H._checkLength(3));
      t9 = P.List_List$filled(20, false, null);
      t10 = P.List_List$filled(20, false, null);
      t11 = Array(20);
      t12 = Array(20);
      ...
      floors = new Z.Scenery(new T.Vector3(t7), 0, new T.Vector3(t8), 200, false, t9, t10, t11, Array(20), Array(20), t12, Array(20), t13, Array(20), t14);
      t10 = floors.getFreeIndex$0();
      $.RedZone_index = t10;
      t8 = $.RedZone_zoom;
      if (t10 < 0 || t10 >= 20)
        return H.ioore(t13, t10);
      t13[t10] = t8;
      t11[t10] = W.ImageElement_ImageElement(null, "/assets/huemanatee/maps/red/red_1.png", null);
      t10 = $.RedZone_index;
      if (t10 >>> 0 !== t10 || t10 >= 20)
      ...
      t14[t10] = new X.Box(100 * t11, 428 * t11);
      t9[t10] = true;
      t10 = floors.getFreeIndex$0();
      $.RedZone_index = t10;
      t11 = $.RedZone_zoom;
      t8 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t8.setValues$3(100 * t11, 92 * t11, 0);
      if (t10 < 0 || t10 >= 20)
      ...
      t10 = $.RedZone_zoom;
      if (t8 >>> 0 !== t8 || t8 >= 20)
        return H.ioore(t14, t8);
      t14[t8] = new X.Box(121 * t10, 335 * t10);
      t9[t8] = true;
      t8 = floors.getFreeIndex$0();
      $.RedZone_index = t8;
      t10 = $.RedZone_zoom;
      t11 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t11.setValues$3(220 * t10, 212 * t10, 0);
      if (t8 < 0 || t8 >= 20)
        return H.ioore(t12, t8);
      t12[t8] = t11;
      t11 = $.RedZone_index;
      t8 = $.RedZone_zoom;
      if (t11 >>> 0 !== t11 || t11 >= 20)
        return H.ioore(t14, t11);
      t14[t11] = new X.Box(120 * t8, 144 * t8);
      t9[t11] = true;
      t11 = floors.getFreeIndex$0();
      $.RedZone_index = t11;
      t8 = $.RedZone_zoom;
      t10 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t10.setValues$3(484 * t8, 0, 0);
      if (t11 < 0 || t11 >= 20)
      ...
      t11 = $.RedZone_zoom;
      t8 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t8.setValues$3(388 * t11, 332 * t11, 0);
      if (t10 < 0 || t10 >= 20)
        return H.ioore(t12, t10);
      t12[t10] = t8;
      t8 = $.RedZone_index;
      ...
      if (t8 >>> 0 !== t8 || t8 >= 20)
        return H.ioore(t14, t8);
      t14[t8] = new X.Box(63 * t10, 24 * t10);
      t9[t8] = true;
      t8 = floors.getFreeIndex$0();
      $.RedZone_index = t8;
      t10 = $.RedZone_zoom;
      t11 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t11.setValues$3(326 * t10, 404 * t10, 0);
      if (t8 < 0 || t8 >= 20)
        return H.ioore(t12, t8);
      t12[t8] = t11;
      t11 = $.RedZone_index;
      ...
      if (t11 >>> 0 !== t11 || t11 >= 20)
        return H.ioore(t14, t11);
      t14[t11] = new X.Box(158 * t8, 24 * t8);
      t9[t11] = true;
      t11 = floors.getFreeIndex$0();
      $.RedZone_index = t11;
      t8 = $.RedZone_zoom;
      t10 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t10.setValues$3(196 * t8, 356 * t8, 0);
      if (t11 < 0 || t11 >= 20)
        return H.ioore(t12, t11);
      t12[t11] = t10;
      t10 = $.RedZone_index;
      ...
      if (t10 >>> 0 !== t10 || t10 >= 20)
        return H.ioore(t14, t10);
      t14[t10] = new X.Box(t11, t11);
      t9[t10] = true;
      t10 = $.RedZone_background;
      level1.background = t10;
      t9 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t9.setValues$3(-60, -135, 0);
      t10.position = t9;
      t2.push(floors);
      t2 = $.RedZone_zoom;
      ...
      t9[0] = 130 * t2;
      t9[1] = 64 * t2;
      level1.spawnPoint = new T.Vector2(t9);
      t2 = t9[0];
      t9 = t9[1];
      t10 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t10.setValues$3(t2, t9, 0);
      t4.position = t10;
      t10 = $.RedZone_zoom;
      t9 = new Float32Array(H._checkLength(2));
      t9[0] = 584 * t10;
      t9[1] = 428 * t10;
      t9 = R.Camera$withCanvas(t1, new T.Vector2(t9));
      level1.camera = t9;
      t9.following = t4;
      t3.push(t4);
      t5.push(t4);
      ...
      t5.setValues$3(268 * t4, 427 * t4, 0);
      t4 = $.RedZone_zoom;
      t6.push(new X.Warpzone(t5, R.RedZone_createLevel2$closure(), 58 * t4, 20 * t4));
      this.loadLevel$1(level1);
      $.get$EventBus_subscribers().push(this);
      t4 = this.Subscriber_filters;
      t4.push("warp");
      t4.push("dead");
      t4 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(new F.HuemanateeClient_closure()), t4._useCapture), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
      t4 = H.setRuntimeTypeInfo(new W._EventStream(window, "keyup", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(new F.HuemanateeClient_closure0()), t4._useCapture), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
      C.Window_methods.get$animationFrame(window).then$1(this.get$gameLoop());
    },
    newlevelcallback$2: function(arg0, arg1) {
      return this.newlevelcallback.call$2(arg0, arg1);
    },
    static: {HuemanateeClient$: function() {
        var t1, t2, t3;
        t1 = document.querySelector("#delve");
        t2 = new T.Vector3(new Float32Array(H._checkLength(3)));
        t2.setValues$3(0, 600, 0);
        t3 = [];
        t2 = new X.PhysicsApplicator(null, t2, true, t3);
        $.get$EventBus_subscribers().push(t2);
        t3.push("collision");
        t2 = new F.HuemanateeClient(null, t1, new A.CollisionDetector(null), null, t2, M.Eric$(), Date.now(), 0, false, null, true, []);
        t2.HuemanateeClient$0();
        return t2;
      }}
  },
  HuemanateeClient_closure: {
    "^": "Closure:21;",
    call$1: function($event) {
      F.EventBus_broadcastEvent(new F.GameEvent("keydown", $event));
    }
  },
  HuemanateeClient_closure0: {
    "^": "Closure:21;",
    call$1: function($event) {
      F.EventBus_broadcastEvent(new F.GameEvent("keyup", $event));
    }
  },
  HuemanateeClient_gameLoop_closure: {
    "^": "Closure:22;_main0$_box_0",
    call$1: function(logic) {
      return logic.update$1(this._main0$_box_0._captured_delta_0);
    }
  },
  HuemanateeClient_onEvent_closure: {
    "^": "Closure:0;_main0$_captured_this_0,_captured_e_1",
    call$0: function() {
      var t1, t2, t3, t4;
      t1 = this._captured_e_1.data;
      t2 = this._main0$_captured_this_0;
      t3 = t2.level.get$spawnPoint().storage[0];
      t2 = t2.level.get$spawnPoint().storage[1];
      t4 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t4.setValues$3(t3, t2, 0);
      J.set$position$x(t1, t4);
      t1.resurrect$0();
    }
  }
},
...
["", "../web/mob.dart", , S, {
  "^": "",
  Mob: {
    "^": "Logic;active<,hidden>,collisionShape<,position*,anchor<"
  }
}],
["", "../web/scenery/movingplatform.dart", , D, {
  "^": "",
  MovingPlatform: {
    "^": "ActiveScenery;velocity,min_x,max_x,max_speed,bufferzone,push,starttime,lasttime,position,rotation,anchorPoint,slowdowntime,kills,used,hidden,images,animations,customDrawables,positions,rotations,zooms,anchors,collisionShapes",
    update$1: function(delta) {
      var time, dt, t1, t2, t3, t4;
      time = Date.now() - this.starttime;
      ...
      if (t2 - t3 < t4) {
        t4 = this.velocity.storage;
        t4[0] = t4[0] + this.push / (1 + t2 - t3) * dt / 1000;
      } else {
        t3 = this.max_x;
        if (t3 - t2 < t4) {
          t4 = this.velocity.storage;
          t4[0] = t4[0] - this.push / (1 + t3 - t2) * dt / 1000;
        }
      }
      t1[0] = t1[0] + this.velocity.storage[0] * dt / 1000;
    }
  }
}],
["", "../web/recipes/orange_zone.dart", , Y, {
  "^": "",
  OrangeZone_createLevel1: [function(canvas, eric) {
    var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11;
    if ($.OrangeZone_index == null) {
      t1 = W.AudioElement_AudioElement("/assets/huemanatee/audio/Depth_Theme_test1.mp3");
      $.OrangeZone_audio = t1;
      t1.loop = true;
      t1.autoplay = true;
      $.OrangeZone_bg_img = W.ImageElement_ImageElement(null, "/assets/huemanatee/maps/red/orange_bg.png", null);
      t1 = new Float32Array(H._checkLength(3));
      t2 = new Float32Array(H._checkLength(3));
      t3 = P.List_List$filled(20, false, null);
      t4 = P.List_List$filled(20, false, null);
      t5 = Array(20);
      t5.fixed$length = Array;
      t6 = Array(20);
      t6.fixed$length = Array;
      t6 = new Z.Scenery(new T.Vector3(t1), 0, new T.Vector3(t2), 200, false, t3, t4, Array(20), Array(20), Array(20), t5, Array(20), Array(20), Array(20), t6);
      $.OrangeZone_background = t6;
      t5 = new T.Vector3(new Float32Array(H._checkLength(3)));
      t5.setValues$3(0, 0, 1.3);
      t6.position = t5;
      t5 = $.OrangeZone_background.getFreeIndex$0();
      $.OrangeZone_index = t5;
      t6 = $.OrangeZone_background;
      t4 = t6.images;
      t3 = $.OrangeZone_bg_img;
      if (t5 < 0 || t5 >= 20)
    ...
    t3 = new Float32Array(H._checkLength(2));
    t4 = new Float32Array(H._checkLength(3));
    t5 = new Float32Array(H._checkLength(3));
    t6 = P.List_List$filled(20, false, null);
    t7 = P.List_List$filled(20, false, null);
    t8 = Array(20);
    t9 = Array(20);
    ...
    t11 = new Z.Scenery(new T.Vector3(t4), 0, new T.Vector3(t5), 200, false, t6, t7, t8, Array(20), Array(20), t9, Array(20), t10, Array(20), t11).getFreeIndex$0();
    $.OrangeZone_index = t11;
    t9 = $.OrangeZone_zoom;
    if (t11 < 0 || t11 >= 20)
      return H.ioore(t10, t11);
    t10[t11] = t9;
    t8[t11] = W.ImageElement_ImageElement(null, "/assets/huemanatee/maps/orange/orange_1_frame.png", null);
    t11 = $.OrangeZone_index;
    if (t11 >>> 0 !== t11 || t11 >= 20)
      return H.ioore(t6, t11);
    t6[t11] = true;
    return new Y.Level(new R.Camera(null, new T.Vector2(t1), 0, 1, null, null, new T.Vector2(t2), null), new T.Vector2(t3), null, null, null, [], [], [], []);
  }, "call$2", "OrangeZone_createLevel1$closure", 4, 0, 29]
}],
["", "../web/physicsapplicator.dart", , X, {
  "^": "",
  PhysicsApplicator: {
    "^": "Subscriber;_physicsapplicator$_level,gravity,Subscriber_subscriber_active,Subscriber_filters",
    onEvent$1: function($event) {
      var t1, t2, t3, t4, t5, t6;
      if ($event.type === "collision") {
        t1 = $event.data;
        if (t1.get$scenecollidee() != null) {
          t2 = t1.collider;
          t2.position = t2.position.$add(0, t1.distanceAlongNormal);
          t2 = t1.collider;
          t3 = t2.velocity;
          t4 = t1.distanceAlongNormal;
          t4.toString;
          t5 = new T.Vector3(new Float32Array(H._checkLength(3)));
          t5.setFrom$1(t4);
          t5 = t5.normalize$0();
          t4 = t1.collider.velocity;
          t1 = t1.distanceAlongNormal;
          t1.toString;
          t6 = new T.Vector3(new Float32Array(H._checkLength(3)));
          t6.setFrom$1(t1);
          t2.velocity = t3.$sub(0, t5.$mul(0, t4.dot$1(t6.normalize$0())));
        }
      }
    },
    update$1: function(delta) {
      C.JSArray_methods.forEach$1(this._physicsapplicator$_level.get$mobs(), new X.PhysicsApplicator_update_closure(this, delta));
    }
  },
  PhysicsApplicator_update_closure: {
    "^": "Closure:5;_physicsapplicator$_captured_this_0,_captured_delta_1",
    call$1: function(mob) {
      var t1;
      if (!mob.get$active())
        return;
      t1 = this._captured_delta_1;
      mob.position = mob.position.$add(0, mob.velocity.$mul(0, t1).$div(0, 1000));
      if (!mob.flying)
        mob.velocity = mob.velocity.$add(0, this._physicsapplicator$_captured_this_0.gravity.$mul(0, t1).$div(0, 1000));
    }
  }
}],
["", "../web/recipes/red_zone.dart", , R, {
  "^": "",
  RedZone_createLevel2: [function(canvas, eric) {
    var t1, t2, t3, t4, level2, t5, t6, t7, t8, t9, t10, t11, t12, floors, spikes, t13, t14, t15, platform, gloop1, gloop2, gloop3;
    t1 = [];
    t2 = [];
    t3 = [];
    t4 = [];
    level2 = new Y.Level(new R.Camera(null, new T.Vector2(new Float32Array(H._checkLength(2))), 0, 1, null, null, new T.Vector2(new Float32Array(H._checkLength(2))), null), new T.Vector2(new Float32Array(H._checkLength(2))), null, null, null, t1, t2, t3, t4);
    t5 = new Float32Array(H._checkLength(3));
    t6 = new Float32Array(H._checkLength(3));
    t7 = P.List_List$filled(20, false, null);
    t8 = P.List_List$filled(20, false, null);
    t9 = Array(20);
    t10 = Array(20);
    ...
    t12 = Array(20);
    t12.fixed$length = Array;
    floors = new Z.Scenery(new T.Vector3(t5), 0, new T.Vector3(t6), 200, false, t7, t8, t9, Array(20), Array(20), t10, Array(20), t11, Array(20), t12);
    t8 = floors.getFreeIndex$0();
    $.RedZone_index = t8;
    t6 = $.RedZone_zoom;
    if (t8 < 0 || t8 >= 20)
    ...
    t11[t8] = t6;
    t9[t8] = W.ImageElement_ImageElement(null, "/assets/huemanatee/maps/red/red_2_frame_comp.png", null);
    t8 = $.RedZone_index;
    if (t8 >>> 0 !== t8 || t8 >= 20)
    ...
    t8 = $.RedZone_zoom;
    if (t6 >>> 0 !== t6 || t6 >= 20)
      return H.ioore(t12, t6);
    t12[t6] = new X.Box(120 * t8, 336 * t8);
    t7[t6] = true;
    t6 = floors.getFreeIndex$0();
    $.RedZone_index = t6;
    t8 = $.RedZone_zoom;
    t9 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t9.setValues$3(220 * t8, 404 * t8, 0);
    if (t6 < 0 || t6 >= 20)
    ...
    t6 = $.RedZone_zoom;
    if (t9 >>> 0 !== t9 || t9 >= 20)
      return H.ioore(t12, t9);
    t12[t9] = new X.Box(192 * t6, 24 * t6);
    t7[t9] = true;
    t9 = floors.getFreeIndex$0();
    $.RedZone_index = t9;
    t6 = new T.Vector3(new Float32Array(H._checkLength(3)));
    ...
    if (t6 >>> 0 !== t6 || t6 >= 20)
      return H.ioore(t12, t6);
    t12[t6] = new X.Box(100 * t9, 428 * t9);
    t7[t6] = true;
    t6 = floors.getFreeIndex$0();
    $.RedZone_index = t6;
    t9 = $.RedZone_zoom;
    t8 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t8.setValues$3(291 * t9, 92 * t9, 0);
    if (t6 < 0 || t6 >= 20)
      return H.ioore(t10, t6);
    t10[t6] = t8;
    t8 = $.RedZone_index;
    ...
    if (t8 >>> 0 !== t8 || t8 >= 20)
      return H.ioore(t12, t8);
    t12[t8] = new X.Box(194 * t6, 96 * t6);
    t7[t8] = true;
    t8 = floors.getFreeIndex$0();
    $.RedZone_index = t8;
    t6 = $.RedZone_zoom;
    t9 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t9.setValues$3(484 * t6, 0 * t6, 0);
    if (t8 < 0 || t8 >= 20)
      return H.ioore(t10, t8);
    t10[t8] = t9;
    t9 = $.RedZone_index;
    ...
    if (t9 >>> 0 !== t9 || t9 >= 20)
      return H.ioore(t12, t9);
    t12[t9] = new X.Box(100 * t8, 428 * t8);
    t7[t9] = true;
    t9 = floors.getFreeIndex$0();
    $.RedZone_index = t9;
    t8 = $.RedZone_zoom;
    t6 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t6.setValues$3(388 * t8, 332 * t8, 0);
    if (t9 < 0 || t9 >= 20)
      return H.ioore(t10, t9);
    t10[t9] = t6;
    t6 = $.RedZone_index;
    ...
    if (t6 >>> 0 !== t6 || t6 >= 20)
      return H.ioore(t12, t6);
    t12[t6] = new X.Box(63 * t9, 24 * t9);
    t7[t6] = true;
    t6 = floors.getFreeIndex$0();
    $.RedZone_index = t6;
    t9 = $.RedZone_zoom;
    t8 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t8.setValues$3(220 * t9, 212 * t9, 0);
    if (t6 < 0 || t6 >= 20)
      return H.ioore(t10, t6);
    t10[t6] = t8;
    t8 = $.RedZone_index;
    ...
    if (t8 >>> 0 !== t8 || t8 >= 20)
      return H.ioore(t12, t8);
    t12[t8] = new X.Box(168 * t6, 24 * t6);
    t7[t8] = true;
    t8 = floors.getFreeIndex$0();
    $.RedZone_index = t8;
    t6 = $.RedZone_zoom;
    t9 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t9.setValues$3(460 * t6, 188 * t6, 0);
    if (t8 < 0 || t8 >= 20)
      return H.ioore(t10, t8);
    t10[t8] = t9;
    t9 = $.RedZone_index;
    ...
    if (t9 >>> 0 !== t9 || t9 >= 20)
      return H.ioore(t12, t9);
    t12[t9] = new X.Box(24 * t8, 240 * t8);
    t7[t9] = true;
    t9 = floors.getFreeIndex$0();
    $.RedZone_index = t9;
    t8 = $.RedZone_zoom;
    t6 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t6.setValues$3(292 * t8, 332 * t8, 0);
    if (t9 < 0 || t9 >= 20)
      return H.ioore(t10, t9);
    t10[t9] = t6;
    t6 = $.RedZone_index;
    ...
    if (t6 >>> 0 !== t6 || t6 >= 20)
      return H.ioore(t12, t6);
    t12[t6] = new X.Box(169 * t9, 24 * t9);
    t7[t6] = true;
    t6 = new Float32Array(H._checkLength(3));
    t7 = new Float32Array(H._checkLength(3));
    t9 = P.List_List$filled(20, false, null);
    t12 = P.List_List$filled(20, false, null);
    t10 = Array(20);
    t10.fixed$length = Array;
    t8 = Array(20);
    t8.fixed$length = Array;
    spikes = new Z.Scenery(new T.Vector3(t6), 0, new T.Vector3(t7), 200, false, t9, t12, Array(20), Array(20), Array(20), t10, Array(20), Array(20), Array(20), t8);
    spikes.kills = true;
    t12 = spikes.getFreeIndex$0();
    $.RedZone_index = t12;
    t7 = $.RedZone_zoom;
    t6 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t6.setValues$3(292 * t7, 325 * t7, 0);
    if (t12 < 0 || t12 >= 20)
    ...
    t8[t6] = new X.Box(168 * t12, 7 * t12);
    t9[t6] = true;
    t6 = spikes.getFreeIndex$0();
    $.RedZone_index = t6;
    t12 = $.RedZone_zoom;
    t7 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t7.setValues$3(220 * t12, 204 * t12, 0);
    if (t6 < 0 || t6 >= 20)
      return H.ioore(t10, t6);
    t10[t6] = t7;
    t7 = $.RedZone_index;
    ...
    t8[t7] = new X.Box(10 * t6, 8 * t6);
    t9[t7] = true;
    t7 = spikes.getFreeIndex$0();
    $.RedZone_index = t7;
    t6 = $.RedZone_zoom;
    t12 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t12.setValues$3(285 * t6, 92 * t6, 0);
    if (t7 < 0 || t7 >= 20)
    ...
    t8[t12] = new X.Box(7 * t7, 96 * t7);
    t9[t12] = true;
    t12 = 296 * t7;
    t9 = new Float32Array(H._checkLength(3));
    t8 = new Float32Array(H._checkLength(3));
    t10 = new Float32Array(H._checkLength(3));
    t6 = P.List_List$filled(20, false, null);
    t11 = P.List_List$filled(20, false, null);
    t5 = Array(20);
    t13 = Array(20);
    ...
    platform = new D.MovingPlatform(new T.Vector3(t9), null, null, null, null, null, null, null, new T.Vector3(t8), 0, new T.Vector3(t10), 200, false, t6, t11, t5, Array(20), Array(20), t13, Array(20), t14, Array(20), t15);
    platform.starttime = Date.now();
    platform.lasttime = 0;
    platform.min_x = t12;
    platform.max_x = 420 * t7;
    platform.max_speed = 15;
    platform.bufferzone = 30 * t7;
    platform.push = 100;
    t8[0] = t12;
    t8[1] = 287 * $.RedZone_zoom;
    t8 = platform.getFreeIndex$0();
    $.RedZone_index = t8;
    t12 = $.RedZone_zoom;
    if (t8 < 0 || t8 >= 20)
      return H.ioore(t14, t8);
    t14[t8] = t12;
    t5[t8] = W.ImageElement_ImageElement(null, "/assets/huemanatee/maps/red/red_2_train.png", null);
    t8 = $.RedZone_index;
    t5 = $.RedZone_zoom;
    if (t8 >>> 0 !== t8 || t8 >= 20)
      return H.ioore(t15, t8);
    t15[t8] = new X.Box(38 * t5, 14 * t5);
    t6[t8] = true;
    t8 = $.RedZone_background;
    level2.background = t8;
    t6 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t6.setValues$3(-60, -135, 0);
    t8.position = t6;
    t1.push(floors);
    t1.push(spikes);
    t1.push(platform);
    ...
    t6[0] = 140 * t1;
    t6[1] = 25 * t1;
    level2.spawnPoint = new T.Vector2(t6);
    gloop1 = G.RedGloopoid$();
    gloop2 = G.RedGloopoid$();
    gloop3 = G.RedGloopoid$();
    t1 = new Float32Array(H._checkLength(2));
    t1[0] = 48;
    t1[1] = 72;
    gloop1.anchor = new T.Vector2(t1);
    t1 = new Float32Array(H._checkLength(2));
    t1[0] = 48;
    t1[1] = 72;
    gloop2.anchor = new T.Vector2(t1);
    t1 = new Float32Array(H._checkLength(2));
    t1[0] = 48;
    t1[1] = 72;
    gloop3.anchor = new T.Vector2(t1);
    t1 = $.RedZone_zoom;
    t8 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t8.setValues$3(345 * t1, 394 * t1, 0);
    gloop1.position = t8;
    t8 = $.RedZone_zoom;
    t1 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t1.setValues$3(362 * t8, 397 * t8, 0);
    gloop2.position = t1;
    t1 = $.RedZone_zoom;
    t8 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t8.setValues$3(333 * t1, 397 * t1, 0);
    gloop3.position = t8;
    t8 = t6[0];
    t6 = t6[1];
    t1 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t1.setValues$3(t8, t6, 0);
    J.set$position$x(eric, t1);
    t1 = $.RedZone_zoom;
    t6 = new Float32Array(H._checkLength(2));
    t6[0] = 584 * t1;
    t6[1] = 428 * t1;
    t6 = R.Camera$withCanvas(canvas, new T.Vector2(t6));
    level2.camera = t6;
    t6.following = eric;
    t2.push(eric);
    t2.push(gloop1);
    ...
    t3 = $.RedZone_zoom;
    t2 = new T.Vector3(new Float32Array(H._checkLength(3)));
    t2.setValues$3(401 * t3, 444 * t3, 0);
    t3 = $.RedZone_zoom;
    t4.push(new X.Warpzone(t2, Y.OrangeZone_createLevel1$closure(), 74 * t3, 20 * t3));
    return level2;
  }, "call$2", "RedZone_createLevel2$closure", 4, 0, 29]
}],
["", "../web/scenery.dart", , Z, {
  "^": "",
  Scenery: {
    "^": "Object;position*,rotation,anchorPoint<,slowdowntime,kills,used<,hidden>,images,animations,customDrawables,positions,rotations,zooms,anchors,collisionShapes",
    getFreeIndex$0: function() {
      var t1, i;
      for (t1 = this.used, i = 0; i < 20; ++i)
        if (t1[i] !== true)
          return i;
      return -1;
    }
...
C.EricState_0 = new M.EricState(0);
C.EricState_1 = new M.EricState(1);
C.EricState_2 = new M.EricState(2);
C.EricState_3 = new M.EricState(3);
C.EricState_4 = new M.EricState(4);
C.EricState_7 = new M.EricState(7);
...
$.OrangeZone_audio = null;
$.OrangeZone_bg_img = null;
$.OrangeZone_background = null;
$.OrangeZone_index = null;
$.OrangeZone_zoom = 2;
$.RedZone_audio = null;
$.RedZone_bg_img = null;
$.RedZone_background = null;
$.RedZone_index = null;
$.RedZone_zoom = 2;
(function(lazies) {
...
}, "undefinedLiteralPropertyPattern", "Assets_animations", "get$Assets_animations", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
}, "animations", "Assets_images", "get$Assets_images", function() {
  return P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
}, "images", "_AsyncRun_scheduleImmediateClosure", "get$_AsyncRun_scheduleImmediateClosure", function() {
  return P._AsyncRun__initializeScheduleImmediate();
}, "scheduleImmediateClosure", "IterableBase__toStringVisiting", "get$IterableBase__toStringVisiting", function() {
  return [];
}, "_toStringVisiting", "EventBus_subscribers", "get$EventBus_subscribers", function() {
  return [];
}, "subscribers", "Scenery_DEFAULT_POSITION", "get$Scenery_DEFAULT_POSITION", function() {
  return T.Vector3$zero();
}, "DEFAULT_POSITION", "Scenery_DEFAULT_ANCHOR", "get$Scenery_DEFAULT_ANCHOR", function() {
...
{func: "", args: [F.Subscriber]},
{func: "", args: [X.Anim]},
{func: "", void: true, args: [Z.Scenery]},
...
{func: "", ret: Y.Level, args: [W.CanvasElement, M.Eric]},
];
$ = null;
